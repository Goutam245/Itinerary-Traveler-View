  ...
  "rounded-2xl border bg-card text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        elevated: "shadow-luxury-hover",
        glass: "glass border-background/30",
        interactive: "shadow-luxury hover:shadow-luxury-hover hover:-translate-y-2 hover:scale-[1.01] cursor-pointer",
        cinematic: "overflow-hidden shadow-luxury-modal",
